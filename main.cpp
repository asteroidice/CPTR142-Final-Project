...
for(int p = 0; p < 1000000; p++)
{
    ...
    cout << "Time / Clock Ticks: " << delta /CLOCKS_PER_SEC << endl;
...
inline void cSearchIntbits(void)
{
    // get size of data file
    //
	struct stat st;
...
void sortMillMarbles(void)
{
    ...
    for(int count=1; count <=1000000; count ++)
    {
        ...
        cout << "\n\nSorted 2000 marbles in " << sum / 1000000 << " uSeconds.";
        cout << "Time / Clock Ticks: " << sum /CLOCKS_PER_SEC << endl;
...
char prompt(char choice)
{
    ...
    cout << "\t2) Search through intbits.txt 1,000,000 times and find average." << endl;
    cout << "\t3) Search through intbits.txt Using Ctime" << endl << endl;
    cout << "\t4) Sort marbles.txt" << endl;
    cout << "\t5) Sort marbles.txt 1,000,000 times." << endl;
    cout << "\t6) Sort marbles.txt with Ctime" << endl;
    ...
    while(choice!='0')
    {
        ...
        switch(choice)
        {
            case '1':
                ...
                break;
            case '2':
                cout << "Searching...1,000,000 times...bear with us -______- ...\n" << endl;
                runMil();
                break;
            case '3':
                cout << "Searching with Ctime...\n" << endl;
                cSearchIntbits();
                break;
            case '4':
                cout << "Sorting now?...\n" << endl;
                ...
                break;
            case '5':
                cout << "Losing marbles...\n\nSorting 1,000,000 x 2,000 marbles..."<< endl;
                sortMillMarbles();
                break;
            case '6':
                cout << "sorting with ctime...\n" << endl;
                cSortMarbles();
            case '0':
                goodbye();
                break;
